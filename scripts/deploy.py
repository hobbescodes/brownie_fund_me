...
def deploy_fund_me():
    ...
    #if we are on a persistant network like rinkeby, use the associated address, otherwise use mocks
    ...
    return fund_me #return fund me so that you can use it in your tests
